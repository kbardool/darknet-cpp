...
ifeq ($(OPENCV), 1) 
COMMON += -DOPENCV  -I'D:/opencv/builds/include/'
CFLAGS += -DOPENCV
...
$(EXEC): obj clean $(OBJS)
	$(CC) $(COMMON) $(CFLAGS) $(OBJS) $(LDFLAGS) -o $@ 

$(OBJDIR)%.o: %.c $(DEPS)
	$(CC) $(COMMON) $(CFLAGS) -c $< -o $@

$(EXEC_CPP): obj-cpp clean-cpp $(OBJS_CPP)
	$(CC_CPP) $(COMMON) $(CFLAGS) $(OBJS_CPP) $(LDFLAGS) -o $@
$(SHARED_CPP): obj-shared-cpp clean-cpp $(OBJS_CPP_SHARED)
	$(CC_CPP) $(COMMON) $(CFLAGS) $(OBJS_CPP_SHARED)  $(LDFLAGS) -shared -o lib$@.so
